...
//        links.put("File download example using Spring REST Controller","https://www.jeejava.com/file-download-example-using-spring-rest-controller/");
        ...
        String[] data0 = {"Securing Spring Boot APIs and SPAs with OAuth 2.0",
        ...
        String[] data1 = {"Add Social Login to Your Spring Boot 2.0 app",
                        "https://developer.okta.com/blog/2018/07/24/social-spring-boot",
                        "How to add Social Login to Your Spring Boot 2.0 app"};

        String[] data2 = {"Building Microservices with Spring Boot Fat (Uber) Jar",
        ...
        links.forEach(record -> {
            linkRepository.save(new Link(record[0], record[1], record[2]));
        });
